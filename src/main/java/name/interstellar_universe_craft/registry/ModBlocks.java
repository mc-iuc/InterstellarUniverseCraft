...
public class ModBlocks {
    ...
    public static final Block ALUMINIUM_ORE = registerBlock("aluminium_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.of(Material.STONE).strength(8.0f,1000.0f).requiresTool(), UniformIntProvider.create(2,4)),
            ModItemGroup.ELEMENT);
    public static final Block DEEPSLATE_ALUMINIUM_ORE = registerBlock("deepslate_aluminium_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.of(Material.STONE).strength(10.0f,1000.0f).requiresTool(), UniformIntProvider.create(2,4)),
            ModItemGroup.ELEMENT);
    //其他
    public static final Block LAMP = registerBlock("lamp",
            new GlassBlock(FabricBlockSettings.of(Material.GLASS).strength(0.3f, 0.3f).sounds(BlockSoundGroup.GLASS).nonOpaque().requiresTool().luminance(15)),
            ModItemGroup.ELEMENT);
